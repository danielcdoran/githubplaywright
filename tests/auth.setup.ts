...
// otpauth://totp/GitHub:danielcdoran?secret=EDL46UJXLQZHOT4S&issuer=GitHub
  ...
  let username = "danielcdoran" ; //process.env.GITHUB_USER;
  let password =  "Theridgeway2073" ;//process.env.GITHUB_PASS;
  let mfaSecret =  "SG5GANAMG7DT2G4X"; //process.env.GITHUB_MFA_SECRET;
